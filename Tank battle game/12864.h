...
extern int LCD_busycheck();
extern void Lcd_clear();
//extern void LDC_draw(int dir,int x,int y);
extern void LDC_draw(int dir,int x,int y,int b);
extern void LDC_draw_bomb(int dir,int x,int y);
#endif /* 12864_H_ */
